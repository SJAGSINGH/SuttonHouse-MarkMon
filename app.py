...
def _extract_sentinel_macro_snapshot(data):
    ...
    return {
        ...
        "s3_confirmed": bool(data.get("s3_confirmed")) if data.get("s3_confirmed") is not None else None,
        "s3_allowed": bool(data.get("s3_allowed")) if data.get("s3_allowed") is not None else None,
        "s3_arm_age_weeks": _safe_int(data.get("s3_arm_age_weeks"), default=None),
        "s3_arm_expired": bool(data.get("s3_arm_expired")) if data.get("s3_arm_expired") is not None else None,
